<template>
  <div class="sidebar">
    ...
    <div class="sidebar_inner">
      ...
      <ul>
        <li class="active">
          <nuxt-link :to="{ name: 'dashboard.feed' }">
        ...
        <li>
          <nuxt-link :to="{ name: 'dashboard.explore' }">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li>
          <nuxt-link :to="{ name: 'dashboard.market' }">
            <i class="uil-store"></i>
            <span> Marketplace </span>
          </nuxt-link>
        </li>
        <li>
          <nuxt-link :to="{ name: 'dashboard.setting' }">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
